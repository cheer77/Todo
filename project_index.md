...
| Метод                       | Операція      | Appwrite SDK           | Параметры                                                    | Описание                                            |
| --------------------------- | ------------- | ---------------------- | ------------------------------------------------------------ | --------------------------------------------------- |
| `getTasks()`                | GET (active)  | `listDocuments()`      | Query: `isDeleted=false`, Sort: `order ASC`                  | Активні задачи                                      |
...
| `getTrashTasks()`           | GET (deleted) | `listDocuments()`      | Query: `isDeleted=true`, Sort: `deletedAt ASC`               | Задачи в кошику                                     |
...
**Призначення**: Автоматично переміщати задачи, завершені більше 1 години тому, до кошика.
...
**Призначення**: Видаляти задачи з кошика, які там більше 24 годин.
...
- Inline badge `.completion-countdown` з обратным отсчётом до auto-trash (1ч)
